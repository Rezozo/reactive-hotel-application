...
public interface RoomService {
    ...
    Flux<RoomInfoDto> getAllByType(String type_title, Boolean status, String direction, LocalDate arrivalDate, LocalDate departureDate);
    Flux<RoomInfoDto> getAll(Boolean status, String direction, LocalDate arrivalDate, LocalDate departureDate);
